...
public class GeminiConversationService {
    ...
    public String processFlightQuery(String userQuery) {
        ...
        try {
            // First, extract flight intent and parameters using NLP
            Map<String, String> extractedParams = nlpService.extractFlightParameters(userQuery);
            logger.debug("Extracted parameters: {}", extractedParams);
    ...
    private List<Flight> getRelevantFlightData(Map<String, String> params) {
        ...
        switch (queryType) {
            ...
            case "route":
                return flightService.getFlightsByRoute(params.get("departure"), params.get("arrival"), limit);
            case "flight_number":
